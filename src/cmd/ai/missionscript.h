...
{
public: AIFlyToWaypoint( const Vector &waypoint, float vel, bool afburn, float range );
...
{
public: AIFlyToWaypointDefend( const Vector &waypoint, float vel, bool afburn, float range, float defend_range );
...
{
public: AIPatrol( int mode, const Vector &area, float range, Unit *around_unit, float patrol_speed );
};

class AIPatrolDefend : public AImissionScript
{
public: AIPatrolDefend( int mode, const Vector &area, float range, Unit *around_unit, float patrol_speed );
};
