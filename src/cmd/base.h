...
public:
            ...
            explicit Link( const std::string &ind, const std::string &pfile ) : pythonfile( pfile )
                , alpha( 1.0f )
                , index( ind )
                , eventMask( ClickEvent )
                , clickbtn( -1 ) {}
            virtual ~Link() {}
#ifdef BASE_MAKER
...
#endif
            virtual ~BasePython() {}
            BasePython( const std::string &ind, const std::string &python, float time ) : BaseObj( ind )
                , pythonfile( python )
                , timeleft( 0 )
                , maxtime( time ) {}
...
public:
            ...
            BaseText( const std::string &texts,
                      ...
                      GFXColor backcol,
                      GFXColor forecol,
                      const std::string &ind ) : BaseObj( ind )
                , text( forecol, backcol )
            {
