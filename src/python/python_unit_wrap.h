...
WRAPPED4( Vector, PositionITTS, Vector, local_posit, Vector, local_velocity, float, speed, bool, steadyITTS, Vector( 0, 0, 0 ) )
WRAPPED0( Vector, Position, Vector( 0, 0, 0 ) )
WRAPPED0( Vector, LocalPosition, Vector( 0, 0, 0 ) )
...
#else
WRAPPED1( double, getMinDis, Vector, pnt, 0 )  //for clicklist
WRAPPED3( float, querySphere, Vector, start, Vector, end, float, my_unit_radius, 0 )
...
voidWRAPPED1( SetPosition, Vector, pos )
voidWRAPPED1( SetCurPosition, Vector, pos )
voidWRAPPED1( SetPosAndCumPos, Vector, pos )
...
voidWRAPPED2( ApplyTorque, Vector, Vforce, Vector, Location )
...
voidWRAPPED2( SetOrientation, Vector, q, Vector, r )
...
voidEXPORT_UTIL5( orbit, UnitWrapper, orbitee, float, speed, Vector, R, Vector, S, Vector, center )
